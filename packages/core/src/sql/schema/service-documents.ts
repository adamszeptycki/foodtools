...
export const InsertServiceDocumentSchema = createInsertSchema(serviceDocuments).omit({
	id: true,
	createdAt: true,
	updatedAt: true,
});
...
// Machine fixes table
export const machineFixes = pgTable("machine_fixes", {
	...defaultFields,
	...
	machineTypeIdx: index("machine_fixes_machine_type_idx").on(table.machineType),
